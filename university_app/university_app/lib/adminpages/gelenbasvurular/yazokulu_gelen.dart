...
class YazOkuluGelen extends StatefulWidget {
  final Future<FirebaseApp> _initialization = Firebase.initializeApp();
  @override
  _YazOkuluGelenState createState() => _YazOkuluGelenState();
}

class _YazOkuluGelenState extends State<YazOkuluGelen> {
...
class _ListPageState extends State<ListPage> {
  Future getPosts() async {
    ...
    QuerySnapshot qn = await firestore.collection("yazokulubasvurular").get();
    return qn.docs;
  }
          ...
          child: ListTile(
            ...
            subtitle: Column(
              children: [
                ...
                Text('Alınan ders:'+widget.post.data()!["alinanDers"]),
              ],
            ),
          ),
        ),
