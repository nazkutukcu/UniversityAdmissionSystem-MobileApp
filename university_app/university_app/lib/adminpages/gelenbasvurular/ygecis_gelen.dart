...
class YGecisGelen extends StatefulWidget {
  final Future<FirebaseApp> _initialization = Firebase.initializeApp();
  @override
  _YGecisGelenState createState() => _YGecisGelenState();
}

class _YGecisGelenState extends State<YGecisGelen> {
...
class _ListPageState extends State<ListPage> {
  Future getPosts() async {
    ...
    QuerySnapshot qn = await firestore.collection("ygecisbasvurular").get();
    return qn.docs;
  }
          ...
          child: ListTile(
            ...
            subtitle: Column(
              children: [
                ...
                Text('Not ortalaması:'+widget.post.data()!["notOrt"]),
              ],
            ),
          ),
        ),
