...
class IntibakGelen extends StatefulWidget {
  final Future<FirebaseApp> _initialization = Firebase.initializeApp();
  @override
  _IntibakGelenState createState() => _IntibakGelenState();
}

class _IntibakGelenState extends State<IntibakGelen> {
...
class _ListPageState extends State<ListPage> {
  Future getPosts() async {
    ...
    QuerySnapshot qn = await firestore.collection("intibakbasvurular").get();
    return qn.docs;
  }
          ...
          child: ListTile(
            ...
            subtitle: Column(
              children: [
                ...
                Text('Muaf ders:'+widget.post.data()!["muafDers"]),
              ],
            ),
          ),
        ),
