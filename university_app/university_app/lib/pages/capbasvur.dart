...
class Capbasvuru extends StatefulWidget {
  ...
  @override
  _Capbasvuru createState() => _Capbasvuru();
}

class _Capbasvuru extends State<Capbasvuru> {
            ...
            child: Column(
              children: <Widget>[
                ...
                Container(
                  ...
                  child: TextFormField(
                    decoration: InputDecoration(
                      labelText: 'Başvuru yapılan bölüm adı',
                      labelStyle: TextStyle(color: Colors.black),
                    ),
                    validator: (val) => val!.isEmpty ? 'başvuru yaptığınız bölümü giriniz' : null,
                    onChanged: (val) {
                      setState(() => basvurulanBolum = val);
                    },
                  ),
                ),
                SizedBox(
...
Container(
                  child: MaterialButton(
                    ...
                    onPressed: () async {
                      ...
                      dynamic result = await storage.setApplyDataCap(
                          name,
                          ogrenciNo,
                          kimlikNo,
                          telNo,
