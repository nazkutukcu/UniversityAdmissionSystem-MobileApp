...
class Dgsbasvur extends StatefulWidget {
  const Dgsbasvur({Key? key}) : super(key: key);

  @override
  _Dgsbasvur createState() => _Dgsbasvur();
}

class _Dgsbasvur extends State<Dgsbasvur> {
            ...
            child: Column(
              children: <Widget>[
                ...
                Container(
                  ...
                  child: TextFormField(
                    decoration: InputDecoration(
                      labelText: 'Not ortalamanı',
                      labelStyle: TextStyle(color: Colors.black),
                    ),
                    validator: (val) => val!.isEmpty ? 'Not ortalamanızı giriniz' : null,
                    onChanged: (val) {
                      setState(() => notOrt = val);
                    },
                  ),
...
Container(
                  child: MaterialButton(
                    ...
                    onPressed: () async {
                      ...
                      dynamic result = await storage.setApplyDataDgs(
                          name,
                          ogrenciNo,
                          kimlikNo,
                          telNo,
                      ...
                      if (result == false) {
                        ...
                        setState(() =>textMessage='BAŞVURU İŞLEMİ GERÇEKLEŞMEDİ TEKRAR DENEYİNİZ!'); 
                      }
