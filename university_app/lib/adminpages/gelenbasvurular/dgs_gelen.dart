...
class DgsGelen extends StatefulWidget {
  final Future<FirebaseApp> _initialization = Firebase.initializeApp();
  @override
  _DgsGelenState createState() => _DgsGelenState();
}

class _DgsGelenState extends State<DgsGelen> {
...
class _ListPageState extends State<ListPage> {
  Future getPosts() async {
    ...
    QuerySnapshot qn = await firestore.collection("dgsbasvurular").get();
    return qn.docs;
  }
